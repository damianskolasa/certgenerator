...
public class ECCertificateCreator extends CertificateCreator {

	public ECCertificateCreator(Date notBefore, Date notAfter, String subject, BigInteger serialNumber) {
